...
export const AdminContext = createContext<EntityContextProviderType | undefined>(undefined);
...
const AdminProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    async function fetchEntities() {
      try {
        ...
        const response = await fetch(`/api/admin/get-list`, {
          method: 'GET',
          headers: {
  ...
  useEffect(() => {
    async function fetchEntities() {
      ...
      try {
        ...
        response = await fetch(`/api/admin/get-by-id/${params.id}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const deleteEntity = async (id: string) => {
    ...
    try {
      ...
      response = await fetch(`/api/admin/delete/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateEntity = async (id: string, { email, name } : Partial<CreateEntityInput>) => {
    ...
    try {
      ...
      response = await fetch(`/api/admin/update/${id}`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
